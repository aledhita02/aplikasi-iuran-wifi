							...
							<div class="table-responsive">
								...
								<table id="example1" class="table table-bordered table-striped table-hover">
									...
									<tbody>
										...
										//ubah berdasarkan kk
										$no = 1;
										$sql = $koneksi->query("SELECT p.id_pend, p.alamat, k.id_kk, k.no_kk, k.kepala, k.alamat, k.desa, k.rt, k.rw, k.kec, k.kab, k.prov
                       FROM tb_kk k
					   left join tb_pdd p on p.id_pend = k.id_kk order by p.alamat");
